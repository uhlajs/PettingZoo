...
class Scenario(BaseScenario):
    ...
    def global_reward(self, world):
        ...
        # Regenerate active landmark
        self.reinit_landmark(world, inactive_landmark)

        return active_landmark_bonus + distance_penalty

    def reinit_landmark(self, world, inactive_landmark):
        active_landmarks = [landmark for i, landmark in enumerate(world.landmarks) if not inactive_landmark[i]]
